      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            Fueled by a passion for coding since my youth, I've honed my skills
            in programming. Pursuing Information Engineering, I combine
            technical acumen with a curious and innovative mindset.
          </p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, scale: 0.5 }}
